...
/* ============================================
   Home Page — Client-side interactive sections
   ============================================ */
...
function Hero() {
  ...
  return (
    <section ref={ref} className="relative h-screen min-h-[640px] max-h-[900px] overflow-hidden flex items-center">
      ...
      {/* Content — always visible in initial HTML for crawlers */}
      <div className="relative z-10 container-main">
        <div className="max-w-2xl">
          ...
          <p className="text-white/70 text-lg mb-8 max-w-xl leading-relaxed animate-[fadeInUp_0.6s_ease-out_0.25s_both]">
            We build AI driven websites, CRM systems, and subscription based growth engines for ambitious teams. From SaaS development and marketing automation to predictive analytics, we help businesses scale faster through focused, technical execution.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 animate-[fadeInUp_0.5s_ease-out_0.35s_both]">
    ...
    <section className="section-padding section-light relative overflow-hidden">
      ...
      <div className="container-main relative">
        <AnimatedSection className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-surface-500">Choose between <Link href="/products" className="text-brand-500 hover:underline">subscription based AI products</Link> for ongoing growth or high impact <Link href="/services" className="text-brand-500 hover:underline">project services</Link> for one time, high value implementations. Not sure which fits? Read our <Link href="/faq" className="text-brand-500 hover:underline">FAQ</Link> or <Link href="/contact" className="text-brand-500 hover:underline">talk to our team</Link>.</p>
        </AnimatedSection>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto relative">
          ...
          <AnimatedSection delay={0.1}>
            <div className="group h-full flex flex-col rounded-2xl border border-surface-100 bg-surface-warm p-8 lg:p-10 transition-all duration-300 hover:border-brand-500/30 hover:shadow-lg">
              ...
              <p className="text-surface-500 text-sm mb-6 leading-relaxed">AI powered systems including <Link href="/products/ai-driven-linkedin-advertising" className="text-brand-500 hover:underline">LinkedIn advertising</Link> and <Link href="/products/ai-powered-crm-analytics-and-lead-management" className="text-brand-500 hover:underline">CRM analytics</Link> that continuously optimize and scale business growth.</p>
          ...
          <AnimatedSection delay={0.2}>
            <div className="group h-full flex flex-col rounded-2xl border border-surface-100 bg-surface-warm p-8 lg:p-10 transition-all duration-300 hover:border-brand-500/30 hover:shadow-lg">
              ...
              <p className="text-surface-500 text-sm mb-6 leading-relaxed">One time builds like <Link href="/services/ai-based-website-building" className="text-brand-500 hover:underline">AI websites</Link>, <Link href="/services/saas-development" className="text-brand-500 hover:underline">SaaS platforms</Link>, and <Link href="/services/ai-powered-crm-building-and-integration" className="text-brand-500 hover:underline">custom CRMs</Link> that create permanent infrastructure for your business growth.</p>
...
function TestimonialHighlight() {
  ...
  return (
    <section className="py-12 lg:py-16 section-dark relative overflow-hidden">
      ...
      <button
        onClick={prev}
        className="absolute left-4 lg:left-8 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-white/10 transition-colors"
      ...
      <button
        onClick={next}
        className="absolute right-4 lg:right-8 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-white/10 transition-colors"
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 mb-5">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-white/40">{t.industry}</p>
              </div>
            </div>
...
/* HomeClient — Composes all homepage sections in order */
