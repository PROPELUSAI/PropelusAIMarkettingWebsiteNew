...
const detailMap: Record<string, DetailOverride> = {
  'ai-based-website-building-and-hosting': {
    longDescription: [
      ...
      'We build responsive, fast-loading websites optimized for search engines and conversions. Our technology stack includes modern frameworks, content delivery networks, and enterprise-grade hosting that ensures your site performs reliably under any traffic conditions.',
      'Beyond the initial build, we provide managed hosting with continuous performance monitoring, security patching, and uptime guarantees. Your website becomes a living growth asset that evolves alongside your business.',
    ],
    ...
    process: ['Discovery workshop and competitive audit', 'Wireframing and UX strategy', 'Visual design and brand integration', 'Development with AI personalization features', 'Performance testing and SEO optimization', 'Launch, monitoring, and managed hosting'],
    faqs: [
      { question: 'What technology stack do you use for website development?', answer: 'We use modern frameworks like Next.js and React, paired with headless CMS solutions and cloud hosting. The specific stack is tailored to your performance, scalability, and content management needs.' },
      ...
      { question: 'What does managed hosting include?', answer: 'Managed hosting covers server maintenance, security updates, performance monitoring, daily backups, and uptime guarantees. We handle the infrastructure so you can focus on your business.' },
    ],
  ...
  'ai-based-mobile-application-development': {
    ...
    relatedSlugs: ['ai-based-website-building-and-hosting', 'ai-powered-crm-building-and-integration', 'cybersecurity-and-data-protection'],
  },
  ...
  'cybersecurity-and-data-protection': {
    ...
    relatedSlugs: ['custom-email-domain-setup', 'ai-based-website-building-and-hosting', 'ai-powered-crm-building-and-integration'],
  },
};
